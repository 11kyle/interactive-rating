...
export default function InteractiveRatingCard(): JSX.Element {
  ...
  return (
    <div className="max-w-[412px] h-[360px] sm:h-[416px] flex flex-col justify-between bg-gradient-to-tr from-[#232A34] to-[#181E27] rounded-[30px] p-6 sm:p-8 mx-6 sm:mx-0">
      {isRated 
        ? <>
            ...
            <div className="self-center grid place-content-center w-[168px] h-8 bg-[#262E38] rounded-full">
              <p className="text-[#FC7614] text-[14px] leading-[22px]">You seleted {active} out of 5</p>
            </div>
            <div className="self-center text-center">
              <h4 className="text-white font-bold text-[24px] leading-[30px] mb-4">Thank you!</h4>
              <p className="text-[#969FAD] text-[14px] leading-[22px]">We appreciate you taking the time to give a rating. If you ever need more support, don’t hesitate to get in touch!</p>
            </div>
          </>
        : <>
            <div className="grid place-content-center w-10 aspect-square bg-[#262E38] rounded-full">
              <svg 
                width="17" 
                height="16" 
                xmlns="http://www.w3.org/2000/svg"
            ...
            <div>
              <h4 className="text-white font-bold text-[24px] leading-[30px] mb-2">How did we do?</h4>
              <p className="text-[#969FAD] text-[14px] leading-[22px]">Please let us know how we did with your support request. All feedback is appreciated to help us improve our offering!</p>
            </div>
              ...
              {ratings.map((rating, index) => (
                <div 
                  ...
                  className={classNames(
                    ...
                    'w-[42px] sm:w-[51px] aspect-square grid place-content-center hover:bg-[#FC7614] rounded-full hover:text-white font-bold text-[14px] leading-6 tracking-[0.0125em] cursor-pointer'
                  )}
                >
                  {rating}
                </div>
            ...
            <button 
              className="w-full h-[45px] bg-[#FC7614] hover:bg-white rounded-full uppercase text-white hover:text-[#FC7614] font-bold text-[14px] leading-[18px] tracking-[1.87px]"
